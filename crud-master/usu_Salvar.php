        ...
        <section class="corpo">
            ...
            <form action="" method="post">
                <div class="form-group">
                    ...
                    <input type="email" name="email" value="<?php echo $lista['email']; ?>" id="email" class="form-control" required /><br>
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <select name="sexo" id="sexo" class="form-control" required>
                                        ...
                                        <option value="1" <?php if ($lista['sexo'] == 1) echo "selected"; ?>>Masculino</option>
                                        <option value="2" <?php if ($lista['sexo'] == 2) echo "selected"; ?>>Feminino</option>
                                    </select>
                                </div>
                                <div class="col">
                                    ...
                                    <select name="nivel_Acesso" id="nivel_Acesso" class="form-control" required>
                                        <option value="">Selecione</option>
                                        <option value="1" <?php if ($lista['nivelAcesso'] == 1) echo "selected"; ?>>Administrador</option>
                                        <option value="2" <?php if ($lista['nivelAcesso'] == 2) echo "selected"; ?>>Operacional</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                ...
                <input type="button" value="Consultar" class="btn btn-outline-secondary" onclick="window.location='usu_Consultar.php';">
            </form>
        </section>
    </div>
</body>
