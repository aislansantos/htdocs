            ...
            <table class="table table-hover tab">
                ...
                foreach ($lista as $item) :
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo 'vendedor_Salvar.php?id=' . $item['id']; ?>" class="btn btn-outline-success">Editar</a>
                            <a href="<?php echo 'vendedor_Deletar.php?id=' . $item['id'].'&nome='.$item['nome']; ?>" class="btn btn-outline-danger">Excluir</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </table>
