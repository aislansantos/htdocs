    ...
    <div class="container">
        ...
        <section class="corpo">
            ...
            <form action="" method="POST">
                ...
                <input type="submit" class="btn btn-outline-secondary" value="Pesquisar"><br><br>
            </form>
                    ...
                    <tr>
                        ...
                        */ ?>
                        <td><?php echo date('d/m/Y', strtotime($item['dataCadastro'])); ?></td>
                            -->
                        <td>
                            <a href="<?php echo 'usu_Salvar.php?id=' . $item['id']; ?>" class="btn btn-outline-success">Editar</a>
                            <a href="<?php echo 'usu_Deletar.php?id=' . $item['id'].'&nome='.$item['nome']; ?>" class="btn btn-outline-danger">Excluir</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </table>
