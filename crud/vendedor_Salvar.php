...
if (!empty($_GET['id'])) {
    $cod = $_GET['id'];
    $lista = $vendedor->consultaEditar($cod);
} else {
        ...
        <section class="corpo">
            ...
            <form action="" method="post">
                <div class="form-group">
                    ...
                    <input type="button" value="CONSULTAR" class="btn btn-info" onclick="window.location='vendedor_Consultar.php';">
                </div>
            </form>
        </section>
    </div>
