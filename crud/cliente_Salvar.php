        ...
        <section class="corpo">
            ...
            <form action="" method="post">
                <div class="form-group">
                    ...
                    <input type="text" name="cidade" value="<?php if (!empty($lista['cidade'])) {
                                                                echo $lista['cidade'];
                                                            } ?>" id="cidade" class="form-control" required /><br>

                    <input type="submit" value="SALVAR" class="btn btn-success">
                    <input type="button" value="CONSULTAR" class="btn btn-info" onclick="window.location='cliente_Consultar.php';">
                </div>
            </form>
        </section>
    </div>
