...
<body class="bg-light">
    <div class="">
        ...
        <section class="corpo">
            <h1 id="content" class="bd-title">Cadastro de Filiais</h1>
            <hr class="my-4">

            <form action="" method="POST">
                <input type="search" name="pesquisar" class="form-control" id="pesquisar" placeholder="Digite o nome"><br>
                <input type="submit" class="btn btn-primary" value="PESQUISAR">
                <input type="button" value="NOVO" class="btn btn-success" onclick="window.location='filial_Salvar.php';">
            </form>
            <br>
            <table class="table table-striped table-dark table-hover tab">
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo 'filial_Salvar.php?id=' . $item['id']; ?>" class="btn btn-info">CONSULTAR</a>
                            <a href="<?php echo 'filial_Deletar.php?id=' . $item['id'] . '&nome=' . $item['nome']; ?>" class="btn btn-danger">EXCLUIR</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </table>
