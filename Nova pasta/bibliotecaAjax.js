...
function EditarLinha(idLinha, cod){
	if(linhaEmEdicao == null){//Se linhaEmEdicao não for nulo...
		...
		celulas[2].innerHTML = '<input type="text" name="preco" value="'+celulas[2].innerHTML+'" maxlength="15">';//Mostrar o campo texto permitindo a edição do preço do produto
		celulas[3].innerHTML = '<a href="#" onclick="Atualizar(document.formulario.nome.value, document.formulario.preco.value, document.formulario.cod.value);"><img src="images/atualizar.gif" alt="Atualizar" /></a><br/>'+'<a href="#" onclick="Cancelar();"><img src="images/cancelar.gif" alt="Cancelar" /></a>';//Monta os links que chamarão as funções para atualizar ou cancelar a edição da linha
		celulas[4].innerHTML = ' ';//Insere um espaço na última célula
	}
